...
public class Ball : MonoBehaviour
{
    ...
    public GameObject invicnbledObj;
    ...
    void Update()
    {
        if(ballState == BallState.Playing)
        {
            ...
            {
                invicnbledObj.SetActive(true);
            }
            else
            {
                invicnbledObj.SetActive(false);
            }
            ...
            if (invicnbledObj.activeInHierarchy)
            {
    ...
    void OnCollisionEnter(Collision target)
    {
        if (!smash)
        {
            ...
            if(target.gameObject.tag != "Finish")
            {
                ...
                float randomScale = Random.Range(0.18f, 0.24f);
    ...
    void OnCollsionStay(Collision target)
    {
